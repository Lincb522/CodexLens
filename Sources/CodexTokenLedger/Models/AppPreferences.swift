...
enum LocalizationCatalog {
    ...
    private static let requiredKeys: Set<String> = [
        ...
        "tibo.headline.confirmed",
        "tibo.headline.announced",
        "tibo.headline.pending",
        "tibo.headline.publicStatus",
        "tibo.headline.awaitingConfirmation",
        "tibo.headline.confirmationEvidence",
        "tibo.headline.announcementEvidence",
        "tibo.headline.confirmedAt",
        "tibo.headline.noNextAnnouncement",
