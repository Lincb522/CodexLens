...
/// Forecasts quota exhaustion only from observed Codex quota percentages.
/// It never converts tokens into quota because ChatGPT plan limits are not a
/// published fixed token allowance.
